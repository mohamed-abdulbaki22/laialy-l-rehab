...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    element: <div><ClothesDonationPage /></div>,
  },
  {
    path: "ToysDonationPage",
    element: <div><ToysDonationPage /></div>,
  },
  {
    path: "SchoolDonationPage",
    element: <div><SchoolDonationPage /></div>,
  },
  {
    path: "FoodDonationPage",
    element: <div><FoodDonationPage /></div>,
  },
  {
    path: "MedicalDonationPage",
    element: <div><MedicalDonationPage /></div>,
  },
  {
    path: "BloodDonationPage",
    element: <div><BloodDonationPage /></div>,
  },
  {
    path: "ClothesDonationPage/:id",
    element: <div><ClothesDetails /></div>,
  },
  {
    path: "SchoolDonationPage/:id",
    element: <div><SchoolDetails /></div>,
  },
  {
    path: "ToysDonationPage/:id",
    element: <div><ToysDetails /></div>,
  },
  {
    path: "FoodDonationPage/:id",
    element: <div><FoodDetails /></div>,
  },
  {
    path: "MedicalDonationPage/:id",
    element: <div><MedicalDetails /></div>,
  },
  {
    path: "BloodDonationPage/:id",
    element: <div><BloodDetails /></div>,
  },
  {
    path: "DonationDetails",
    element: <div> <DonationDetails/></div>
  },
  {
    path: "TeachingPage",
