...
const FoodDetails = () => {
    ...
    const {
        ...
        error,
        isPending,
    } = useFetch("http://localhost:4000/FoodPosts/" + id);
    const [count, setCount] = useState(0)

    const updateDataInJson = async (id, updatedQuantity) => {
        try {
            await fetch(`http://localhost:4000/FoodPosts/${id}`, {
                ...
                <div className="container">
                  <section className="post-body">
                    ...
                    <div className="post-content">
                      <h2>{Food.type}s are required</h2>
                      <p>
                        <strong>Details:</strong>
                        <br />- <strong>Type:</strong> {Food.type}
                        <br />- <strong>name:</strong> {Food.name}
                        <br />- <strong>note:</strong> {Food.note}
                        <br />- <strong>Quantity Requested:</strong>{" "}
                        {Food["quantity requested"]}
                      </p>
