...
const SchoolDetails = () => {
    ...
    const {
        ...
        error,
        isPending,
    } = useFetch("http://localhost:4000/SchoolPosts/" + id);
    const [count, setCount] = useState(0)

    const updateDataInJson = async (id, updatedQuantity) => {
        try {
            await fetch(`http://localhost:4000/SchoolPosts/${id}`, {
            ...
            console.error('Error updating School supplies:', error);
            // Handle error
        }
    };
                      ...
                      <p>
                        ...
                        {Supplies.type === "book" ? (
                          <>
                            ...
                            <br />- <strong>book name:</strong> {Supplies.name}
                            <br />- <strong>book author:</strong> {Supplies.bookAuthor}
                            <br />- <strong>language:</strong> {Supplies.language}
                            <br />- <strong>edition:</strong> {Supplies.edition}
                            <br />- <strong>summary:</strong> {Supplies.summary}
